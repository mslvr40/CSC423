										...
										while($row = mysql_fetch_Array($result)) {
											...
											<form id = "<?php echo htmlspecialchars($row['ItemNumber']); ?>"  method='POST'>
												<tr>
													...
													<td> <input type = 'button' onClick="clickMe(1, <?php echo htmlspecialchars($row['ItemNumber']); ?>)" value='Search this items deals'>

														<script>
															function clickMe(i, frm){

																document.getElementById(frm).action="../model/report3.php";
