...
<div class="content row">
  ...
  <section class="form-section row">
                                    ...
                                    <form  action='../model/modify_item.php' method='post'>
                                        ...
                                        <div class="one_half last"><span class="wpcf7-form-control-wrap lastname">Category<input type="text" name = "itemCategory" id = "itemCategory" value = "<?php echo htmlspecialchars($initCategory); ?>" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Category" /></span></div>
                                        <div class="one_half"><span class="wpcf7-form-control-wrap tele">Department<input type="text" name = "itemDepartment" id = "itemDepartment" value = "<?php echo htmlspecialchars($initDepartment); ?>" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" aria-required="true" aria-invalid="false" placeholder="Department" /></span></div>
                                        <table>
                                            <tr>
